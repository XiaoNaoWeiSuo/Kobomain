...
class ModelScreenState extends State<ModelScreen> {
  ...
  void initState() {
    ...
    lntoHome(token).then((value) {
      ...
      discreption = {
        "4":
            "短期中银宝是蚂蚁财富推出的一种理财产品低风险、高收益、短期灵活的理财产品，它的出现旨在让投资者以较低的风险获得更高的收益，追求更稳定的资产增值效果，这种理财产品的特点是资金随时可取，没有固定期限，可以灵活调整资产配置，通过合理地分散资产，降低风险，中银宝可为投资者带来更多的收益。 短期中银宝活期存款利率为${data1[widget.label]["interest"]}%，投资时长1H，利息=存款余额*${data1[widget.label]["interest"]}%。平台要求：新用户累计充值15000以上即可提款。",
        "5":
            "短期余额宝是蚂蚁集团旗下的余额增值服务和活期资金管理服务产品，于2013年6月推出，余额宝特点是操作简便、低门槛、零手续费、可随取随用，是中国用户数最多的货币基金。 短期余额宝活期存款利率为${data1[widget.label]["interest"]}%，投资时长3H，利息=存款余额*${data1[widget.label]["interest"]}%",
        "6":
            "短期余利宝是蚂蚁集团旗下的一款货币基金产品，由阿里巴巴旗下的支付平台——支付宝推出。其只要目的是为用户提供便捷、快速、高收益的理财服务。余利宝投资于货币市场工具和银行存款等低风险金融产品，用户可以随时买入或赎回，没有任何费用和锁定时间。 短期余额宝活期存款利率为${data1[widget.label]["interest"]}%，投资时长7H，利息=存款余额*${data1[widget.label]["interest"]}%",
        "7":
            "长期中银宝是蚂蚁财富推出的一种理财产品低风险、高收益、短期灵活的理财产品，它的出现旨在让投资者以较低的风险获得更高的收益，追求更稳定的资产增值效果，这种理财产品的特点是资金随时可取，没有固定期限，可以灵活调整资产配置，通过合理地分散资产，降低风险，中银宝可为投资者带来更多的收益。 短期中银宝活期存款利率为${data1[widget.label]["interest"]}%，投资时长24H，利息=存款余额*${data1[widget.label]["interest"]}%",
        "8":
            "长期余额宝是蚂蚁集团旗下的余额增值服务和活期资金管理服务产品，于2013年6月推出，余额宝特点是操作简便、低门槛、零手续费、可随取随用，是中国用户数最多的货币基金。 长期余额宝活期存款利率为${data1[widget.label]["interest"]}%，投资时长72H，利息=存款余额*${data1[widget.label]["interest"]}%",
        "9":
            "长期余利宝是蚂蚁集团旗下的一款货币基金产品，由阿里巴巴旗下的支付平台——支付宝推出。其只要目的是为用户提供便捷、快速、高收益的理财服务。余利宝投资于货币市场工具和银行存款等低风险金融产品，用户可以随时买入或赎回，没有任何费用和锁定时间。 长期余利宝活期存款利率为${data1[widget.label]["interest"]}%，投资时长360H，利息=存款余额*${data1[widget.label]["interest"]}%"
      };
      setState(() {});
    });
  }
